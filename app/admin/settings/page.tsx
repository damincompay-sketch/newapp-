          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  أدخل الرقم بالصيغة الدولية بدون علامة + (مثال: 967777777777 لليمن)
                </p>
              </div>
              ...
              <div className="p-4 bg-[#25D366]/10 rounded-xl border border-[#25D366]/20">
                ...
                <p className="text-sm text-muted-foreground">
                  عند الضغط على زر الواتساب، سيتم فتح محادثة مع الرقم: +{localSettings.whatsappNumber || '967XXXXXXXXX'}
                </p>
              </div>
            </CardContent>
          </Card>
