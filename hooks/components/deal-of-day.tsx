...
import { dealOfTheDay } from '@/lib/data'
...
export function DealOfDay() {
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      const endTime = new Date(dealOfTheDay.endsAt).getTime()
      const now = Date.now()
  ...
  const { product, discount } = dealOfTheDay
  const discountedPrice = product.wholesalePrice * (1 - discount / 100)
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-8 flex flex-col justify-center">
              ...
              <div className="text-sm text-muted-foreground mb-4">
                الحد الأدنى للطلب: {product.minQuantity} {product.unitAr}
              </div>
